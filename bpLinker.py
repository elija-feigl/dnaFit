...
class Linker(object):
    ...
    def _link_staples(self):
        ...
        for i, staple in enumerate(self.design.staples):
            ...
            for j in idx_bases:
                try:    
                    res_ids.append(self.fit.staples[idx_segment].residues[j].resindex)

                except:
                    print("something went wrong - excluded base ", j, "on helix ", staple[j].h, )
                    res_ids.append(-1)
                    pass
...
class Design(object):
    ...
    def __init__(self, path):
        ...
        self.scaffold = self._clean_scaffold(self.strands) #TODO: multiscaffold
    ...
    def _clean_scaffold(self, strands):
        ...
        scaffold_clean = [base for base in scaffold if base.num_deletions == 0 and base.num_insertions == 0]
    ...
    def _clean_staple(self, strands):
        ...
        staples_clean = []
        for stra in staples:
            staples_clean.append([base for base in stra if base.num_deletions == 0 and base.num_insertions == 0])
